		...
		<div class="form-layout" >
			...
			<form:form   action="${registerUrl}"   method="post" modelAttribute="customer"     class="form-horizontal"  >
				...
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
					<div class="col-xs-9">
						<form:errors path="customerPhoneNumebr" cssStyle="color: #ff0000" />
					</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						...
						<form:input path="customerPhoneNumebr" class="form-control" placeholder="Enter Phone Number" id="custometPhoneNumber" />
					</div>
				</div>
